...
UPDATE iam_channel_identities SET channel_type = 'local' WHERE channel_type IN ('web', 'cli');
UPDATE iam_user_channel_bindings SET channel_type = 'local' WHERE channel_type IN ('web', 'cli');
UPDATE bot_channel_configs SET channel_type = 'local' WHERE channel_type IN ('web', 'cli');
UPDATE iam_channel_identity_bind_codes SET channel_type = 'local' WHERE channel_type IN ('web', 'cli');
