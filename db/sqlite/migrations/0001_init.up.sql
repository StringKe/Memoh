...
CREATE TABLE IF NOT EXISTS iam_channel_identities (
  id TEXT PRIMARY KEY,
  user_id TEXT REFERENCES iam_users(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS bots (
  id TEXT PRIMARY KEY,
  owner_user_id TEXT NOT NULL REFERENCES iam_users(id) ON DELETE CASCADE,
  type TEXT NOT NULL,
  display_name TEXT,
  avatar_url TEXT,
  timezone TEXT,
...
CREATE TABLE IF NOT EXISTS bot_acl_rules (
  ...
  channel_identity_id TEXT REFERENCES iam_channel_identities(id) ON DELETE CASCADE,
  subject_channel_type TEXT,
  source_channel TEXT,
  source_conversation_type TEXT,
  source_conversation_id TEXT,
  source_thread_id TEXT,
  created_by_user_id TEXT REFERENCES iam_users(id) ON DELETE SET NULL,
  created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS iam_channel_identity_bind_codes (
  id TEXT PRIMARY KEY,
  token TEXT NOT NULL,
  issued_by_user_id TEXT NOT NULL REFERENCES iam_users(id),
  channel_type TEXT,
  expires_at TEXT,
  used_at TEXT,
  used_by_channel_identity_id TEXT REFERENCES iam_channel_identities(id),
  created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS bot_history_messages (
  ...
  sender_channel_identity_id TEXT REFERENCES iam_channel_identities(id),
  sender_account_user_id TEXT REFERENCES iam_users(id),
...
CREATE TABLE IF NOT EXISTS tool_approval_requests (
  ...
  session_id TEXT NOT NULL REFERENCES bot_sessions(id) ON DELETE CASCADE,
  route_id TEXT REFERENCES bot_channel_routes(id) ON DELETE SET NULL,
  channel_identity_id TEXT REFERENCES iam_channel_identities(id) ON DELETE SET NULL,
  ...
  requested_by_channel_identity_id TEXT REFERENCES iam_channel_identities(id) ON DELETE SET NULL,
  decided_by_channel_identity_id TEXT REFERENCES iam_channel_identities(id) ON DELETE SET NULL,
